...
?>
			...
			<tfoot><tr><td colspan="2">
				<input type="submit" class="button-1" style="margin-right:10px;" name="Save" value="<?echo ($arResult["ID"] > 0? GetMessage("subscr_upd"):GetMessage("subscr_add"))?>" />
				<input type="reset" class="button-1" value="<?echo GetMessage("subscr_reset")?>" name="reset" />
			</td></tr></tfoot>
			</table>
