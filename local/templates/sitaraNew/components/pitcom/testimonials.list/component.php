<? if (!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED !== true) die();
	...
	if ($this->StartResultCache(false, array($arNavigation))) {
		...
		$arFilter = array("IBLOCK_ID"        => IntVal($arParams["IBLOCK_ID"]), "ACTIVE" => "Y", "ACTIVE_DATE" =>
			"Y", 'PROPERTY_ELEMENT' => $arParams['ID']);
		$arSelect = array("ID", "IBLOCK_ID", "NAME", "DATE_ACTIVE_FROM", "PREVIEW_TEXT", "DETAIL_PICTURE","PREVIEW_PICTURE",
			'DETAIL_PAGE_URL', 'DATE_CREATE');
